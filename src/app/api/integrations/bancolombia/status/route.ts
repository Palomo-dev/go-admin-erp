// ============================================================
// GET /api/integrations/bancolombia/status
// Consulta el estado de una sesion QR Bancolombia (usado por QrPoller).
// ============================================================
...
export async function GET(request: NextRequest) {
  try {
    ...
    // 2. Si sigue pendiente y tiene datos de conexion, validar transferencia en Bancolombia
    if (
      ...
      try {
        ...
        // Si el proveedor indica aprobado, reflejarlo en la respuesta
        ...
        console.error('[API Bancolombia Status] Error consultando proveedor:', pollErr);
      }
    }
    ...
    console.error('[API Bancolombia Status] Error:', err);
    return NextResponse.json(

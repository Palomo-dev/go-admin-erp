...
export default function CRMConversationDetailPage() {
  ...
  const handleAssign = async (memberId: number | null) => {
    ...
    try {
      ...
      toast({
        ...
        description: memberId ? 'La conversación ha sido asignada' : 'Se ha removido la asignación',
      });
    } catch (error) {
    ...
    <div className="h-screen flex flex-col bg-gray-50 dark:bg-gray-950">
      ...
      <div className="flex-1 flex overflow-hidden">
        ...
        <div className="flex-1 flex flex-col min-w-0">
          <MessageTimeline messages={messages} customerName={customerName} loading={messagesLoading} />

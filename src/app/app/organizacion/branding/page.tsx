          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div className="flex items-center gap-3">
              ...
              <div className={`p-2 rounded-lg bg-purple-100 ${themeClass("", "bg-purple-900/30")}`}>
                <Palette className={`h-6 w-6 text-purple-600 ${themeClass("", "text-purple-400")}`} />
              </div>
              <div>
            ...
            <div className="flex items-center gap-2">
              ...
              {settings?.is_published ? (
                <div className={`flex items-center gap-2 px-3 py-1.5 bg-green-100 text-green-700 rounded-md text-sm ${themeClass("", "bg-green-900/30 text-green-400")}`}>
                  <Globe className="h-4 w-4" />
                  {t('published')}
                </div>
              ) : (
                <div className={`flex items-center gap-2 px-3 py-1.5 bg-gray-100 text-gray-600 rounded-md text-sm ${themeClass("", "bg-gray-800 text-gray-400")}`}>
                  <Globe className="h-4 w-4" />
                  {t('draft')}
                </div>
              )}
        ...
        {isLoading ? (
          ...
          <div className="p-4 sm:p-6">
            <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
              <TabsList className={`flex flex-wrap justify-start gap-1 h-auto p-1 bg-gray-100 mb-6 ${themeClass("", "bg-gray-800")}`}>
                {TAB_IDS.map((tabId) => {
                  ...
                  return (
                    <TabsTrigger
                      key={tabId}
                      value={tabId}
                      className={`flex items-center gap-2 px-4 py-2 data-[state=active]:bg-white ${themeClass("", "data-[state=active]:bg-gray-700")}`}
                    >

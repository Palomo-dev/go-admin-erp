  ...
  if (isLoading) {
    return (
      <div className="p-6 flex items-center justify-center min-h-[50vh]">
        ...
        <span className={`ml-3 text-gray-600 ${resolvedTheme === 'dark' ? "text-gray-400" : ""}`}>Cargando envío...</span>
      </div>
    );
  }
  ...
  if (!shipment) {
    return (
      <div className="p-6 text-center">
        ...
        <h2 className={`text-xl font-semibold text-gray-900 ${resolvedTheme === 'dark' ? "text-white" : ""}`}>Envío no encontrado</h2>
      </div>
    );
  }
          ...
          <div>
            <div className="flex items-center gap-3 flex-wrap">
              ...
              {shipment.shipment_number && (
                <span className={`text-sm font-medium text-gray-500 bg-gray-100 px-2 py-0.5 rounded ${resolvedTheme === 'dark' ? "text-gray-400 bg-gray-800" : ""}`}>
                  {shipment.shipment_number}
                </span>
              )}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <Card className="p-4">
              <h3 className={`font-semibold text-gray-900 mb-3 flex items-center gap-2 ${resolvedTheme === 'dark' ? "text-white" : ""}`}>
                <User className="h-4 w-4" />
                Remitente
              </h3>
              <div className="flex items-start gap-3">
                {orgInfo?.logo_url ? (
                  <img src={orgInfo.logo_url} alt={orgInfo.name} className={`w-12 h-12 rounded-full object-cover border border-gray-200 shrink-0 ${resolvedTheme === 'dark' ? "border-gray-700" : ""}`} />
                ) : (
                ...
                <div className="min-w-0 flex-1 space-y-1.5 text-sm">
                  ...
                  {orgInfo?.phone && (
                    <p className={`flex items-center gap-2 text-gray-600 ${resolvedTheme === 'dark' ? "text-gray-400" : ""}`}>
            ...
            <Card className="p-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                ...
                {shipment.delivery_instructions && (
                  <div className={`md:col-span-2 bg-blue-50 rounded-lg p-3 text-sm text-blue-700 ${resolvedTheme === 'dark' ? "bg-blue-900/20 text-blue-300" : ""}`}>
                  ...
                  <div className="flex items-start gap-2">
                    ...
                    <div>
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <p className={`font-medium text-blue-600 ${resolvedTheme === 'dark' ? "text-blue-400" : ""}`}>{driverInfo.name}</p>
                      </div>
                      {driverInfo.phone && (
        ...
        <div className="space-y-4">
          ...
          {shipment.notes && (
            <Card className="p-4">
              <h3 className={`font-semibold text-gray-900 mb-2 ${resolvedTheme === 'dark' ? "text-white" : ""}`}>Notas</h3>
              <p className={`text-sm text-gray-600 ${resolvedTheme === 'dark' ? "text-gray-400" : ""}`}>{shipment.notes}</p>
            </Card>
          )}

          {shipment.status === 'delivered' && pod && (
            <Card className={`p-4 border-green-200 bg-green-50 ${resolvedTheme === 'dark' ? "bg-green-900/20" : ""}`}>
              <div className={`flex items-center gap-2 text-green-700 ${resolvedTheme === 'dark' ? "text-green-400" : ""}`}>
                <CheckCircle className="h-5 w-5" />
                <span className="font-medium">Entregado exitosamente</span>
              </div>
              <p className={`text-sm text-green-600 mt-1 ${resolvedTheme === 'dark' ? "text-green-500" : ""}`}>
          ...
          {shipment.status === 'returned' && (
            <Card className={`p-4 border-orange-200 bg-orange-50 ${resolvedTheme === 'dark' ? "bg-orange-900/20" : ""}`}>
              <div className={`flex items-center gap-2 text-orange-700 ${resolvedTheme === 'dark' ? "text-orange-400" : ""}`}>

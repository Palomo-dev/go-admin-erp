...
export function MisEnviosEmpty({ hasShipments }: MisEnviosEmptyProps) {
  ...
  return (
    <Card className="p-12 text-center">
      {hasShipments ? (
        <>
          <Search className={`h-12 w-12 text-gray-300 mx-auto mb-3 ${themeClass("", "text-gray-600")}`} />
        ...
        <>
          <Package className={`h-12 w-12 text-gray-300 mx-auto mb-3 ${themeClass("", "text-gray-600")}`} />
          <p className={`text-gray-500 ${themeClass("", "text-gray-400")}`}>

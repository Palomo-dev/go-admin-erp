    ...
    try {
      ...
      const [tripsData, statsData, routesData, vehiclesData, driversData, branchesData] = await Promise.all([
        tripsService.getTrips(organizationId, {
          ...
          branchId: branchFilter !== 'all' ? parseInt(branchFilter, 10) : undefined,
        }),
        tripsService.getTripStats(organizationId, dateStr, branchFilter !== 'all' ? parseInt(branchFilter, 10) : null),

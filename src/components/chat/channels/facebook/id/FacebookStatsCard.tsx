...
import type { FacebookStats } from '@/lib/services/facebookChannelService';

interface FacebookStatsCardProps {
  stats: FacebookStats;
}

export default function FacebookStatsCard({ stats }: FacebookStatsCardProps) {
  const statItems = [
    {

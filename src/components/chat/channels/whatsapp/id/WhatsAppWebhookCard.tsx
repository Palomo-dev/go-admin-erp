...
interface WhatsAppWebhookCardProps {
  channelId: string;
  credentials: WhatsAppCredentials | null;
}

export default function WhatsAppWebhookCard({ channelId, credentials }: WhatsAppWebhookCardProps) {
    ...
    <Card className="bg-white dark:bg-gray-800 border-gray-200 dark:border-gray-700">
      <CardHeader>
        ...
        <CardDescription className="text-gray-500 dark:text-gray-400">
          Configura estos valores en tu cuenta de Meta Business Suite
        </CardDescription>
      </CardHeader>

/**
 * Rediseño UX de Secuencias (brief 6.3), ronda 4 (cierre) — contrato sobre el
 * fuente de lo que jsdom no cubre: que los tres botones «Inscribir» usan el
 * motivo probado (`enrollBlockReason`), que los códigos de la RPC pasan por
 * `enrollErrorText`, que la X del `Sheet` compartido es visible en oscuro y
 * que la confirmación de borrado ya no sondea el DOM.
 */

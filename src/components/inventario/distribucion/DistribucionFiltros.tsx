...
import { FiltrosTransferencias, Branch } from '../transferencias/types';
import { TransferenciasService } from '../transferencias/TransferenciasService';

interface DistribucionFiltrosProps {
  onFiltrosChange: (filtros: FiltrosTransferencias) => void;
}

export function DistribucionFiltros({ onFiltrosChange }: DistribucionFiltrosProps) {
    ...
    <div className="space-y-4">
      <div className="flex flex-col sm:flex-row gap-3">
        ...
        <Select value={filtros.estado} onValueChange={(v) => handleChange('estado', v)}>
          ...
          <SelectContent className="dark:bg-gray-800 dark:border-gray-600">
            ...
            <SelectItem value="complete">Recibido</SelectItem>
      ...
      {mostrarFiltros && (
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 p-4 bg-gray-50 dark:bg-gray-800/50 rounded-lg border dark:border-gray-700">
          <div>
            <label className="block text-sm font-medium mb-1 dark:text-gray-300">Sucursal Origen</label>
          ...
          <div>
            <label className="block text-sm font-medium mb-1 dark:text-gray-300">Sucursal Destino</label>

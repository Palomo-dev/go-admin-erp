...
import { moduleSubroutes } from '@/config/moduleConfig';
...
const DynamicSidebar = memo(({ organizationId, collapsed = false, onSignOut }: DynamicSidebarProps) => {
  ...
  // Memoizar módulos que deben expandirse automáticamente
  const modulesToExpand = useMemo(() => {

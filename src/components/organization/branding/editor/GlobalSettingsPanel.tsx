...
export default function GlobalSettingsPanel({
  ...
  return (
    <div className="space-y-4">
      {/* Colores */}
      <div>
        <Label className={`text-xs text-gray-500 mb-2 block ${themeClass("", "text-gray-400")}`}>{t('colors')}</Label>
        <div className="grid grid-cols-2 gap-2">
          <div className="space-y-1">
            <span className={`text-[10px] text-gray-500 ${themeClass("", "text-gray-500")}`}>{t('primary')}</span>
            <div className="flex items-center gap-1.5">
              ...
              />
              <span className={`text-[10px] text-gray-400 font-mono ${themeClass("", "text-gray-500")}`}>
                {settings.primary_color || '#3B82F6'}
              </span>
            </div>
          </div>
          <div className="space-y-1">
            <span className={`text-[10px] text-gray-500 ${themeClass("", "text-gray-500")}`}>{t('secondary')}</span>
            <div className="flex items-center gap-1.5">
              <input
                type="color"
          ...
          <div className="space-y-1">
            <span className={`text-[10px] text-gray-500 ${themeClass("", "text-gray-500")}`}>{t('accent')}</span>
            <div className="flex items-center gap-1.5">
              <input
                type="color"
          ...
          <div className="space-y-1">
            <span className={`text-[10px] text-gray-500 ${themeClass("", "text-gray-500")}`}>{t('background')}</span>
            <div className="flex items-center gap-1.5">
              <input
                type="color"
      ...
      {/* Tipografía */}
      <div>
        <Label className={`text-xs text-gray-500 mb-2 block ${themeClass("", "text-gray-400")}`}>{t('typography')}</Label>
        <div className="space-y-2">
          <div className="space-y-1">
            <span className={`text-[10px] text-gray-500 ${themeClass("", "text-gray-500")}`}>{t('headings')}</span>
            <Select
              value={settings.font_heading || 'Inter'}
              onValueChange={(val) => onUpdate({ font_heading: val })}
            >
              <SelectTrigger className={`h-7 text-xs bg-white border-gray-300 text-gray-800 ${themeClass("", "bg-white/5 border-gray-600 text-white")}`}>
                <SelectValue />
              </SelectTrigger>
              <SelectContent>
                {FONTS.map((font) => (
          ...
          <div className="space-y-1">
            <span className={`text-[10px] text-gray-500 ${themeClass("", "text-gray-500")}`}>{t('body')}</span>
            <Select
      ...
      {/* Modo tema */}
      <div>
        <Label className={`text-xs text-gray-500 mb-2 block ${themeClass("", "text-gray-400")}`}>{t('themeMode')}</Label>
      ...
      {/* Header Style */}
      <div>
        <Label className={`text-xs text-gray-500 mb-2 block ${themeClass("", "text-gray-400")}`}>{t('headerStyle')}</Label>
        <Select
      ...
      {/* Header CTA */}
      <div>
        <Label className={`text-xs text-gray-500 mb-2 block ${themeClass("", "text-gray-400")}`}>{t('headerButton')}</Label>
        <div className="space-y-2">
          <Input
            value={settings.hero_cta_text || ''}
            onChange={(e) => onUpdate({ hero_cta_text: e.target.value })}
            placeholder={t('buttonText')}
            className={`h-7 text-xs bg-white border-gray-300 text-gray-800 placeholder:text-gray-400 ${themeClass("", "bg-white/5 border-gray-600 text-white placeholder:text-gray-500")}`}
          />
          <Input
      ...
      {/* Botón Comprar Ahora */}
      <div>
        <Label className={`text-xs text-gray-500 mb-2 block ${themeClass("", "text-gray-400")}`}>🛒 Botón &quot;Comprar ahora&quot;</Label>
        <div className="flex items-center justify-between">
          <span className={`text-[10px] text-gray-600 ${themeClass("", "text-gray-400")}`}>Mostrar en tarjetas de productos</span>
          <Switch
      ...
      <div>
        <Label className={`text-xs text-gray-500 mb-2 block ${themeClass("", "text-gray-400")}`}>🛒 Texto botón del carrito</Label>
        <div className={`space-y-3 rounded-md border p-2 ${themeClass("", "border-gray-700")}`}>
          <div className="space-y-1">
            <span className={`text-[10px] text-gray-500 ${themeClass("", "text-gray-500")}`}>Modo</span>
            <Select
              value={cartMode}
          ...
          <div className="space-y-1">
            <span className={`text-[10px] text-gray-500 ${themeClass("", "text-gray-500")}`}>
            ...
            {cartTexts.map((text: string, i: number) => (
              <div key={i} className="flex items-center gap-1">
                <Input
                  ...
                  className={`h-7 text-xs bg-white border-gray-300 text-gray-800 flex-1 ${themeClass("", "bg-white/5 border-gray-600 text-white")}`}
                />
                {cartTexts.length > 1 && (
                  <button
                    onClick={() => {
      ...
      {/* Countdown Timer */}
      <div>
        <Label className={`text-xs text-gray-500 mb-2 block ${themeClass("", "text-gray-400")}`}>⏰ Countdown Timer</Label>
        <div className="space-y-3">
          {/* Activar/Desactivar */}
          <div className="flex items-center justify-between">
            <span className={`text-[10px] text-gray-600 ${themeClass("", "text-gray-400")}`}>Activar countdown</span>
            <Switch
          ...
          {(settings as any).countdown_enabled && (
            <>
              {/* Título */}
              <div className="space-y-1">
                <span className={`text-[10px] text-gray-500 ${themeClass("", "text-gray-500")}`}>Texto</span>
                <Input
                  ...
                  className={`h-7 text-xs bg-white border-gray-300 text-gray-800 placeholder:text-gray-400 ${themeClass("", "bg-white/5 border-gray-600 text-white")}`}
                />
              </div>
              ...
              {(settings as any).countdown_mode === 'custom' ? (
                <div className="space-y-1">
                  <span className={`text-[10px] text-gray-500 ${themeClass("", "text-gray-500")}`}>Fecha fin</span>
                  <Input
                    type="datetime-local"
                    value={(settings as any).countdown_end_date || ''}
                    onChange={(e) => onUpdate({ ...settings, countdown_end_date: e.target.value } as any)}
                    className={`h-7 text-xs bg-white border-gray-300 text-gray-800 ${themeClass("", "bg-white/5 border-gray-600 text-white")}`}
                  />
                </div>
              ) : (
                <>
                  <div className="space-y-1">
                    <span className={`text-[10px] text-gray-500 ${themeClass("", "text-gray-500")}`}>Zona horaria</span>
                    <Select
                  ...
                  <div className="space-y-1">
                    <span className={`text-[10px] text-gray-500 ${themeClass("", "text-gray-500")}`}>Hora de reinicio (0-23)</span>
                    <Input
                      type="number"
                      min={0}
                      max={23}
              ...
              {/* Dónde mostrar */}
              <div className="space-y-2">
                <span className={`text-[10px] text-gray-500 ${themeClass("", "text-gray-500")}`}>Mostrar en</span>
                <div className="space-y-1.5">
                  <div className="flex items-center justify-between">
                    <span className={`text-[10px] text-gray-600 ${themeClass("", "text-gray-400")}`}>Header</span>
                    <Switch
                  ...
                  <div className="flex items-center justify-between">
                    <span className={`text-[10px] text-gray-600 ${themeClass("", "text-gray-400")}`}>Carrito</span>
                    <Switch
                  ...
                  <div className="flex items-center justify-between">
                    <span className={`text-[10px] text-gray-600 ${themeClass("", "text-gray-400")}`}>Detalle producto</span>
                    <Switch
                  ...
                  <div className="flex items-center justify-between">
                    <span className={`text-[10px] text-gray-600 ${themeClass("", "text-gray-400")}`}>Hero / Inicio</span>
                    <Switch
                  ...
                  <div className="flex items-center justify-between">
                    <span className={`text-[10px] text-gray-600 ${themeClass("", "text-gray-400")}`}>Checkout</span>
                    <Switch
      ...
      {/* Urgencia de compra */}
      <div>
        <Label className={`text-xs text-gray-500 mb-2 block ${themeClass("", "text-gray-400")}`}>� Urgencia de compra</Label>
        <div className={`space-y-2 rounded-md border p-2 ${themeClass("", "border-gray-700")}`}>
          <div className="flex items-center justify-between">
            <span className={`text-[10px] text-gray-600 ${themeClass("", "text-gray-400")}`}>Mostrar en checkout</span>
            <Switch

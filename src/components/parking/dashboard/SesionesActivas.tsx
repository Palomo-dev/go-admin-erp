...
import { Car, Clock, AlertTriangle, MapPin } from 'lucide-react';
import { cn } from '@/utils/Utils';
import type { ActiveSession } from '@/lib/services/parkingDashboardService';
                  ...
                  <div
                    className={cn(
                      ...
                      session.is_at_risk
                        ...
                        : 'bg-cyan-100 dark:bg-cyan-800 text-cyan-600 dark:text-cyan-300',
                    )}
                  >

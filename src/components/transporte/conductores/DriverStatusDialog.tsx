  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-md">
        ...
        <div className="py-4">
          <div className={`flex items-center gap-3 p-4 bg-gray-50 rounded-lg ${themeClass("", "bg-gray-800")}`}>
          ...
          {!newStatus && (
            <div className={`mt-4 p-3 bg-yellow-50 rounded-lg flex items-start gap-2 ${themeClass("", "bg-yellow-900/20")}`}>
          ...
          {newStatus && (
            <div className={`mt-4 p-3 bg-green-50 rounded-lg flex items-start gap-2 ${themeClass("", "bg-green-900/20")}`}>
              <CheckCircle2 className="h-5 w-5 text-green-600 flex-shrink-0 mt-0.5" />
              <p className={`text-sm text-green-700 ${themeClass("", "text-green-300")}`}>

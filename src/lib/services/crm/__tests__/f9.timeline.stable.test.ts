/**
 * F9 — timeline v2: casos adversarios estables (consolidado el 2026-09-21).
 *
 * ORIGEN: los escribió el TESTER en la ronda 1 (`TEST-F9-r1.md`,
 * `timelineAdversarial`) como reproducción de 10 defectos; en ronda 2 el builder
 * invirtió los asserts para afirmar el comportamiento correcto, conservando el
 * escenario, el mock fiel y el número de test. Cada caso comprueba lo contrario
 * de lo que reproducía y varios añaden comprobaciones extra (sin duplicados, la
 * fila llega a salir, etc.).
 *
...
describe('F9 · timeline v2 — casos adversarios (de tester r1, corregidos en r2)', () => {

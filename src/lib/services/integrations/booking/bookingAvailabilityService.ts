 ...
 */
export function createBookingAvailabilityService(clients: ChannelManagerClients) {
...
export type BookingAvailabilityService = ReturnType<typeof createBookingAvailabilityService>;

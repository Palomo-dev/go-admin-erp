 ...
 */
export function createBookingContentService(clients: ChannelManagerClients) {
...
export type BookingContentService = ReturnType<typeof createBookingContentService>;

 ...
 */
export function createBookingReservationService(clients: ChannelManagerClients) {
...
export type BookingReservationService = ReturnType<typeof createBookingReservationService>;

 ...
 */
export function createExpediaAvailabilityService(clients: ChannelManagerClients) {
...
export type ExpediaAvailabilityService = ReturnType<typeof createExpediaAvailabilityService>;

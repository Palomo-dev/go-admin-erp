 ...
 */
export function createExpediaProductService(clients: ChannelManagerClients) {
...
export type ExpediaProductService = ReturnType<typeof createExpediaProductService>;

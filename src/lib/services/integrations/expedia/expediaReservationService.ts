 ...
 */
export function createExpediaReservationService(clients: ChannelManagerClients) {
...
export type ExpediaReservationService = ReturnType<typeof createExpediaReservationService>;

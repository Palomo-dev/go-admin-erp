...
const ORG_PALETTE: OrgColor[] = [
  ...
  {
    bg: 'bg-gradient-to-br from-red-500 to-red-700 dark:from-red-600 dark:to-red-900',
    border: 'border-red-200 dark:border-red-700',
    containerBg: 'bg-red-50 dark:bg-red-900/30',
    containerBorder: 'border-red-100 dark:border-red-800',
  ...
  {
    bg: 'bg-gradient-to-br from-pink-500 to-pink-700 dark:from-pink-600 dark:to-pink-900',
    border: 'border-pink-200 dark:border-pink-700',
    containerBg: 'bg-pink-50 dark:bg-pink-900/30',
    containerBorder: 'border-pink-100 dark:border-pink-800',
  ...
  {
    bg: 'bg-gradient-to-br from-sky-500 to-sky-700 dark:from-sky-600 dark:to-sky-900',
    border: 'border-sky-200 dark:border-sky-700',
    containerBg: 'bg-sky-50 dark:bg-sky-900/30',
    containerBorder: 'border-sky-100 dark:border-sky-800',
    text: 'text-sky-900 dark:text-sky-100',
  },
  {
    bg: 'bg-gradient-to-br from-yellow-500 to-yellow-700 dark:from-yellow-600 dark:to-yellow-900',
    border: 'border-yellow-200 dark:border-yellow-700',
    containerBg: 'bg-yellow-50 dark:bg-yellow-900/30',
    containerBorder: 'border-yellow-100 dark:border-yellow-800',
    text: 'text-yellow-900 dark:text-yellow-100',
  },
  {
    bg: 'bg-gradient-to-br from-slate-400 to-slate-600 dark:from-slate-500 dark:to-slate-800',
    border: 'border-slate-200 dark:border-slate-700',
    containerBg: 'bg-slate-50 dark:bg-slate-900/30',
    containerBorder: 'border-slate-100 dark:border-slate-800',

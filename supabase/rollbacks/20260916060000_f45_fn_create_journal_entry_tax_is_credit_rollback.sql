-- Rollback F-45: revertir fn_create_journal_entry, fn_auto_journal_sale, fn_auto_journal_sale_pos
-- a su estado anterior (sin p_tax_is_credit, IVA siempre al debito).

-- 1. Revertir fn_create_journal_entry: DROP firma nueva + CREATE firma vieja
...
-- 2. Revertir fn_auto_journal_sale: quitar p_tax_is_credit := true
...
-- 3. Revertir fn_auto_journal_sale_pos: quitar p_tax_is_credit := true
...
-- El rollback restaura la firma de 12 args; los GRANT deben apuntar a esa firma.

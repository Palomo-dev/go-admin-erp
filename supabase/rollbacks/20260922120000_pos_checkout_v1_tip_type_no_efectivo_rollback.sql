-- Rollback de 20260922120000_pos_checkout_v1_tip_type_no_efectivo.sql
--
-- Restaura la definición de pos_checkout_v1 de 20260921100000 (tip_type por el
-- primer elemento del sobre, 'card' solo si es 'card'). No toca datos.
